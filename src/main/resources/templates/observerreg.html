...
<body>
    <div class="container">
        <div class="content">
            ...
            <div class="login-link">
                <span>Already have an account? <a href="observerlogin.html">Login</a></span>
            </div>
            <form onsubmit="redirectToObserverHome(event)">
    ...
    <script>
        function redirectToObserverHome(event) {
            event.preventDefault();
            window.location.href = "observerhome.html";
        }
    </script>
</body>
</html>